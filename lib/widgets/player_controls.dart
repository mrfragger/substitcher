      ...
      children: [
        ...
        PopupMenuButton<String>(
          ...
          itemBuilder: (context) => [
            ...
            const PopupMenuItem(
              value: 'editvttshow',
              child: Text('load _vttshow.vtt Edit (TAB)'),
            ),
            const PopupMenuItem(
              value: 'useBlurShadow',
            ...
            const PopupMenuItem(
              ...
              child: Text('Copy Current Subtitle (u / U / Ctrl+u)'),
            ),
            const PopupMenuItem(
              value: 'set_default',
              child: Text('Set Font/Color as Default (Ctrl+t)'),
            ),
            PopupMenuItem(
              value: 'apply_default',
              child: Tooltip(
                ...
                child: const Text('Apply Font/Color Default (t)'),
              ),
            ),
              const PopupMenuItem(
        ...
        if (!isYouTubeStream && isVideoFile && !Platform.isAndroid)
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              ...
              const PopupMenuItem(value: 'startDefiningTrackedBlur', child: Text('(Mac) Motion-Tracking Blur ( _ )')),
              const PopupMenuItem(value: 'open_lut_picker', child: Text('LUTs Picker ( Ctrl+L )')),
